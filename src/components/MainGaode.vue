    ...
    export default {
        ...
        methods: {
                ...
                AMapLoader.load({
                    ...
                    .then((AMap) => { //AMap是函数AMapLoader的输出值，作为新函数的入参         
                        this.map = new AMap.Map("container", {
                            ...
                            zoom: 16, // 初始化地图级别
                            center: [116.3218436876086,40.001745137724534], // 初始化地图中心点位置1
                            //center: [116.3143388666221,39.99743636137005], // 初始化地图中心点位置2
                            //center: [116.31617170464314,40.00535552289242], // 初始化地图中心点位置3
                            //center: [116.3181073207547,39.997153173466025], // 初始化地图中心点位置4
                            draggable: true
                        });


                        //console.log(testData);
                        const itemImportanceMap=this.getLabelImportant(testData20,this.map);//计算每一个Label的重要性
            ...
            interactiveLabeling(itemImportanceMap,map,AMap){  
                ...
                //#region 每次处理前需要清除当前地图中的所有Markers和Texts
